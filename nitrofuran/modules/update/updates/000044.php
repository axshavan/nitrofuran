...
if(isset($_POST['install_stamps']) && $_POST['install_stamps'])
{
...
<form action="/admin/?module=update&page=1&proceed" method="post" id="submit_form">
    ...
    <input type="button" value="Нет" onclick="document.getElementById('install_stampa').value=0;document.getElementById('submit_form').submit();">
</form>
<?
    die();
}
